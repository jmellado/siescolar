...
class Copias_seguridad_controller extends CI_Controller {
	...
	public function generar(){
    	...
    	$tables = array('administradores', 'anos_lectivos', 'areas', 'asignaturas', 'asistencias', 'datos_institucion', 'documentos', 'historial_estados', 'horarios', 'notificaciones', 'personas', 'roles', 'usuarios', 'estudiantes', 'padres', 'madres', 'estudiantes_padres', 'profesores', 'acudientes', 'estudiantes_acudientes', 'niveles_educacion', 'grados_educacion', 'grados', 'grupos', 'salones', 'cursos', 'matriculas', 'pensum', 'cargas_academicas', 'desempenos', 'notas', 'nivelaciones', 'nivelaciones_finales', 'retiros', 'logros', 'logros_asignados', 'actividades', 'notas_actividades', 'tipos_causales', 'causales', 'acciones_pedagogicas', 'seguimientos_disciplinarios', 'elecciones', 'candidatos_eleccion', 'listado_votantes', 'categorias', 'cronogramas', 'paises', 'departamentos', 'municipios', 'conceptos_pagos', 'pagos', 'criterios', 'criterios_asignados', 'promocion');
