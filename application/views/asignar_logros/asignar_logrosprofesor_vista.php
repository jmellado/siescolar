			        				...
			        				<div class="col-md-offset-1 col-md-3">
				        				<div class="form-group">
											<label for="periodo">PERIODO</label>
												<select class="form-control" id="periodoAL" name="periodo">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div id="cursos_logrosAL1">
												<select class="form-control" id="id_cursoAL" name="id_curso">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div id="asignaturas_logrosAL1">
												<select class="form-control" id="id_asignaturaAL" name="id_asignatura">
