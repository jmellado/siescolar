...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/asistencias_estudiante_consultar.js" defer></script>
								...
								<table border='1' id="lista_asistencias" class="table table-bordered table-condensed table-hover table-striped">
									<thead>
										<tr>
											...
											<th width="300" style="text-align: center;"><i class='fa fa-clone'></i>&nbsp;Asignatura</th>
