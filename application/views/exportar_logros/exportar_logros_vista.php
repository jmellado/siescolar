...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/exportar_logros.js" defer></script>

<div class="container-fluid">

	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class='fa fa-download'></i>&nbsp;EXPORTAR PLANILLA DE LOGROS</h1>
        </div>
    </div>
    	...
    	<div class="col-md-12">
    		<div class="panel panel-default">
                <div class="panel-body">
                	<form role="form" action="<?php echo base_url(); ?>exportar_logros_controller/exportar" name="" method="post" id="form_exportar_logros">
