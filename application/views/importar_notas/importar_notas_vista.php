...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/importar_notas.js" defer></script>

<div class="container-fluid">

	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class='fa fa-upload'></i>&nbsp;IMPORTAR NOTAS</h1>
        </div>
    </div>
