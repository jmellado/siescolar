      ...
      <div class="modal-body">
      	...
      	<div class="col-sm-offset-3 col-sm-7">
			<div class="input-group custom-search-form">
				<input type="text" class="form-control" id="identificacion_profesor" name="identificacion_profesor" placeholder="Identificacion Profesor" onkeypress="return valida(event)">
        ...
        <form role="form" action="<?php echo base_url(); ?>logros_controller/insertar" name="" method="post" id="form_logros">
        	...
        	<div class="col-md-12">
        		<div class="form-group">
					...
					<p><textarea name="descripcion_logro" id="descripcion_logro" cols="50" rows="4" placeholder="Describir logro.." disabled></textarea></p>
				</div>	
        	</div>
      ...
      <div class="modal-body">
        ...
        <form role="form" id="form_logros_actualizar">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label style="visibility:hidden" for="espacio"></label>
					<input type="text" class="form-control" id="espacio" name="espacio" placeholder="espacio" style="visibility:hidden">
				</div>
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<label for="descripcion_logro">DESCRIPCION LOGRO</label>
					<p><textarea name="descripcion_logro" id="descripcion_logrosele" cols="60" rows="4" placeholder="Descripcion logro"></textarea></p>
				</div>
