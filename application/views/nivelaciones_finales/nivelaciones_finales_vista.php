<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/nivelaciones_finales.js" defer></script>
...
<div class="container-fluid">
	...
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class='fa fa-sliders'></i>&nbsp;GESTIÓN DE NIVELACIONES FINALES</h1>
        </div>
    </div>
    ...
    <div class="row">
    	...
    	<div class="col-lg-3">
    		<div class="form-group">
    			<button type="submit" name="btn_agregar_nivelacion" id="btn_agregar_nivelacion" class="btn btn-success"><i class='fa fa-plus'></i>&nbsp;Registrar Nivelación Final</button>
    		</div>	
    	</div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class='fa fa-plus'></i>&nbsp;REGISTRAR NIVELACIONES FINALES</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="panel panel-default">
		    <div class="panel-body">
		        ...
		        <form role="form" action="<?php echo base_url(); ?>nivelaciones_finales_controller/insertar" name="" method="post" id="form_nivelaciones">
		    			...
		    			<div class="panel-body">
		    				<div class="col-md-3">
		    					<div class="form-group">
									...
									<div id="ano_lectivo_nivelacion1">
										<select class="form-control" id="ano_lectivoNV" name="ano_lectivo">
...
<div id="modal_actualizar_nivelacion" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><i class='fa fa-refresh'></i>&nbsp;NIVELACIÓN FINAL</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="panel panel-default">
		    <div class="panel-body">
		        ...
		        <form role="form" id="form_nivelaciones_actualizar">
		        	...
		        	<input type="hidden" class="form-control" id="id_nivelacionsele" name="id_nivelacion_final">
