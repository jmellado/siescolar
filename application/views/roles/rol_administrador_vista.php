      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>pensum_controller/index"><i class="fa fa-circle-o"></i>Pensum</a></li>
            <li><a href="<?php echo base_url(); ?>pensum_controller/adicionar_asignatura"><i class="fa fa-circle-o"></i>Adicionar Asignatura</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Gestionar Seguimientos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>seguimientos_controller/registrar"><i class="fa fa-clipboard"></i>Registrar</a></li>
            <li><a href="<?php echo base_url(); ?>seguimientos_controller/consultar"><i class="fa fa-list-alt"></i>Consultar</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>nivelaciones_controller/index"><i class="fa fa-clipboard"></i>Nivelaciones Por Período</a></li>
            <li><a href="<?php echo base_url(); ?>nivelaciones_finales_controller/index"><i class="fa fa-clipboard"></i>Nivelaciones Finales</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>criterios_promocion_controller/index"><i class="fa fa-check-square-o"></i>Criterios De Promoción</a></li>
            ...
            <li><a href="<?php echo base_url(); ?>informes_promocion_controller/index"><i class="fa fa-clipboard"></i>Informes De Promoción</a></li>
          </ul>
        </li>
