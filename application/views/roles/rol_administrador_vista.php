                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>grupos_controller/index">GRUPOS</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>salones_controller/index">SALONES</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>matriculas_controller/index">MATRICULAS</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>logros_controller/index">LOGROS</a>
                            </li>
                        </ul>
                    </li>
                </ul>
