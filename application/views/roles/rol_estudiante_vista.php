...
<body class="hold-transition skin-blue fixed sidebar-mini" onload="nobackbutton();">
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url(); ?>notificaciones_controller/index_estudiante">
            <i class="fa fa-envelope"></i>
            <span>Mis Mensajes</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url(); ?>horarios_controller/horario_estudiante">
