...
<body class="hold-transition skin-green fixed sidebar-mini" onload="nobackbutton();">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-mini"><b>P</b>RF</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Profesor</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url(); ?>cargas_academicas_controller/index_profesor">
            <i class="fa fa-th"></i>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>logros_controller/index_profesor"><i class="fa fa-clipboard"></i>Registrar</a></li>
            <li><a href="<?php echo base_url(); ?>asignar_logros_controller/index_profesor"><i class="fa fa-indent"></i>Asignar</a></li>
          </ul>
        </li>
        <li>
