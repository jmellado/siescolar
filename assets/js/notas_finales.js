        ...
        success:function(respuesta) {
                ...
                if (registros.notas.length > 0) {
                    ...
                    for (var i = 0; i < registros.notas.length; i++) {
                        html +="<tr><td>"+[i+1]+"</td><td style='display:none'>"+registros.notas[i].id_nota+"</td><td style='display:none'>"+registros.notas[i].id_asignatura+"</td><td width='200'>"+registros.notas[i].nombre_asignatura+"</td><td width='40' style='text-align:center'>"+registros.notas[i].p1+"</td><td width='40' style='text-align:center'>"+registros.notas[i].p2+"</td><td width='40' style='text-align:center'>"+registros.notas[i].p3+"</td><td width='40' style='text-align:center'>"+registros.notas[i].p4+"</td><td width='80' style='text-align:center'>"+registros.notas[i].nota_final+"</td><td width='80' style='text-align:center'>"+registros.notas[i].definitiva+"</td><td style='display:none'>"+registros.notas[i].id_desempeno+"</td><td width='80' style='text-align:center'>"+registros.notas[i].nombre_desempeno+"</td></tr>";
                    };
